 ...
 */
public class AsyncCorporateCardResponse extends BroadcastReceiver {
	
	//private final static String TAG = AsyncCorporateCardResponse.class.getSimpleName();
	private Handler mHandler;
	private GreenPointsResponse corporateCardResponse;
	 ...
	 */
	public GreenPointsResponse getCorporateCardResponse(){
		return this.corporateCardResponse;
	}
	...
	public void onReceive(Context context, Intent intent) {
		...
		//if connection error
		if (ServiceConstant.INTENT_ACTION_CORPORATE_CARD_ERROR.equals(receiveAction)) {
		...
		if (ServiceConstant.INTENT_ACTION_CORPORATE_CARD_RESPONSE.equals(receiveAction)) {
			//Log.i(TAG,"Response received...");
			GreenPointsResponse corporateCardResponse = (GreenPointsResponse) intent.getExtras().get(ServiceConstant.PARAM_OUT_MSG);
			this.corporateCardResponse = corporateCardResponse;
			callSuccessHandler();
			context.unregisterReceiver(this);
		}
	...
	public void registerReceiver(Context applicationContext){
		...
		filter.addAction(ServiceConstant.INTENT_ACTION_CORPORATE_CARD_RESPONSE);
		filter.addAction(ServiceConstant.INTENT_ACTION_CORPORATE_CARD_ERROR);
