 ...
 */
public class ScheduleHafasMessageAdapter {
    private LayoutInflater layoutInflater;
    private List<HafasMessage> hafasMessageList;
    private Activity activity;
    public ScheduleHafasMessageAdapter(Activity activity, List<HafasMessage> objects){
    ...
    public void getScheduleHafasMessageView(final int position, LinearLayout linearLayout) {
        ...
        final ImageView ivTriangle = (ImageView) convertView.findViewById(R.id.iv_schedule_detail_triangle_icon);
