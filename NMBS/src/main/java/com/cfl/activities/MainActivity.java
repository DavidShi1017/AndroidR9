...
import com.cfl.activities.view.DialogLogout;
import com.cfl.activities.view.DialogMyOptions;
import com.cfl.activity.BaseActivity;
import com.cfl.adapter.DossierHomeAdapter;
...
import com.cfl.listeners.RatingListener;
		...
		if(shouldShowWizard) {
			...
			if(messageService.getMessageResponse() != null){
				...
				if (showMessages != null && showMessages.size() > 0) {
					...
					startActivity(com.cfl.activities.MessageWizardActivity.createIntent(MainActivity.this, showMessagesMobileMessageResponse));
				} else {
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cfl.activities.MessageActivity.createIntent(MainActivity.this, messageService.getMessageResponse()));
								isGoto = false;
							}
						}
					});
...
/*		new Thread(new Runnable() {
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationBoardActivity.createIntent(MainActivity.this, null));
								isGoto = false;
							}
						}
					});
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationInfoActivity.createIntent(MainActivity.this));
								isGoto = false;
							}
						}
					});
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.AlertActivity.createIntent(MainActivity.this));
								isGoto = false;
							}
						}
					});
	...
	public void openOldMyTickeActivity(View view){
		startActivity(com.cfl.activity.MyTicketsActivity.createIntent(this));
	}
