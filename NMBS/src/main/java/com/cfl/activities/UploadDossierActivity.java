...
import com.cfl.R;
import com.cfl.activities.view.AllCapTransformationMethod;
...
import com.cfl.model.Order.OrderParameterFeedbackTypes;
import com.cfl.model.validation.IOrderParameterFeedback;
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cfl.activities.MessageActivity.createIntent(UploadDossierActivity.this, messageService.getMessageResponse()));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationBoardActivity.createIntent(UploadDossierActivity.this, null));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationInfoActivity.createIntent(UploadDossierActivity.this));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.AlertActivity.createIntent(UploadDossierActivity.this));
								isGoto = false;
								finish();
							}
						}
