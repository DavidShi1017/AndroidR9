...
import com.cfl.activities.view.DialogSubNotification;
import com.cfl.activity.BaseActivity;
import com.cfl.adapter.DossierDetailConnectionAdapter;
import com.cfl.adapter.DossierDetailStationInfoNameAdapter;
import com.cfl.adapter.DossierDetailStationInfoTextAdapter;
import com.cfl.adapter.DossierDetailTicketAdapter;
import com.cfl.application.NMBSApplication;
import com.cfl.async.RealTimeInfoAsyncTask;
import com.cfl.async.RefreshDossierAsyncTask;
...
//        Log.e("isExpandConnection", "isExpandConnection..." + isExpandConnection);
    ...
    public void click2call(View view){
        startActivity(com.cfl.activities.CallCenterActivity.createIntent(DossierDetailActivity.this, clickToCallScenarioId, null, dossier));
    }
    public void exchange(View view){
        startActivity(com.cfl.activities.CallCenterActivity.createIntent(DossierDetailActivity.this, ClickToCallService.Exchange, null, dossier));
    }
