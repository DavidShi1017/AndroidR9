...
import com.cfl.model.StationBoardQuery.StationBoardFeedbackTypes;
import com.cfl.model.Train;
...
public class StationBoardActivity extends BaseActivity {
	...
	public void showStationboardResult(View view){
		...
		if(StationBoardFeedbackTypes.CORRECT == isValidate){
			startActivity(com.cfl.activities.StationboardSearchResultActivity.createIntent(StationBoardActivity.this, stationBoardQuery, true));
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cfl.activities.MessageActivity.createIntent(StationBoardActivity.this,
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationInfoActivity.createIntent(StationBoardActivity.this));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.AlertActivity.createIntent(StationBoardActivity.this));
								isGoto = false;
								finish();
							}
						}
