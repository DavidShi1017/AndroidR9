...
import com.cfl.adapter.StationInfoAdapter;
import com.cfl.application.NMBSApplication;
import com.cfl.async.GetStationInfoAsync;
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cfl.activities.MessageActivity.createIntent(StationInfoActivity.this, messageService.getMessageResponse()));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.StationBoardActivity.createIntent(StationInfoActivity.this, null));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cfl.activities.AlertActivity.createIntent(StationInfoActivity.this));
								isGoto = false;
								finish();
							}
						}
