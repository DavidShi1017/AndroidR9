...
import com.cfl.adapter.MyTicketsDnrReferenceAdapter;
...
import com.cfl.async.UploadDossierAsyncTask;
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            ...
                            if(isGoto){
                                startActivity(com.cfl.activities.MessageActivity.createIntent(MyTicketsActivity.this, messageService.getMessageResponse()));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cfl.activities.StationBoardActivity.createIntent(MyTicketsActivity.this, null));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cfl.activities.StationInfoActivity.createIntent(MyTicketsActivity.this));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cfl.activities.AlertActivity.createIntent(MyTicketsActivity.this));
                                isGoto = false;
                                finish();
                            }
                        }
