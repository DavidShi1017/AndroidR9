...
public class CheckOptionConverter {

    public CheckOption parseResponse(String jsonResponse) throws Exception{
        CheckOption response = null;
        try {
            ...
            response = gson.fromJson(jsonResponse, CheckOption.class);
