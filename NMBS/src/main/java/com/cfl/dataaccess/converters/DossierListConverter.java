...
public class DossierListConverter {

    public DossiersList parseResponse(String jsonResponse) throws Exception{
        DossiersList response = null;
        try {
            ...
            response = gson.fromJson(jsonResponse, DossiersList.class);
