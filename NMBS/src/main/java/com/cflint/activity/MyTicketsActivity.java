...
import com.cflint.activities.view.DialogSuccessful;
import com.cflint.adapter.TicketsAdapter.ReloadCallback;
import com.cflint.adapter.TicketsTitleAdapter;
import com.cflint.adapter.TicketsTitleAdapter.RefreshCallback;
import com.cflint.application.NMBSApplication;
import com.cflint.async.OrderAsyncTask;
...
public class MyTicketsActivity extends BaseActivity implements RefreshOldDossierListener{
	...
	public void viewRefreshedDossier() {
		startActivity(com.cflint.activities.MyTicketsActivity.createIntent(MyTicketsActivity.this));
		//loadData();
	}
