...
public class ResendInfoConverter {

    public ResendInfoResponse parseResponse(String jsonResponse) throws Exception{
        ResendInfoResponse response = null;
        try {
            ...
            response = gson.fromJson(jsonResponse, ResendInfoResponse.class);
