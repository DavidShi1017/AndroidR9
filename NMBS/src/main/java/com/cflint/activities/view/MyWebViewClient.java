...
public class MyWebViewClient extends WebViewClient implements  ActivityCompat.OnRequestPermissionsResultCallback{
        ...
        if(screen != null && !screen.isEmpty()){
            ...
            if(navigation != null && navigation.equalsIgnoreCase("InApp")){
                ...
                if (scheme.equalsIgnoreCase("bepgenapp")) {
                    ...
                    LogUtils.d(TAG, "telNumber...." + telNumber);
    ...
    private void showSimpleDialog() {
        ...
        builder.setTitle(com.cflint.R.string.general_information);
        builder.setMessage(com.cflint.R.string.general_server_unavailable);

        //监听下方button点击事件
        builder.setPositiveButton(com.cflint.R.string.general_ok, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                dialogInterface.dismiss();
            }
        });
        builder.setNegativeButton(com.cflint.R.string.general_refresh, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                webView.reload();
                dialogInterface.dismiss();
