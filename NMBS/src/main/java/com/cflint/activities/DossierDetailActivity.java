...
import com.cflint.activities.view.DialogSubNotification;
import com.cflint.activity.BaseActivity;
import com.cflint.adapter.DossierDetailConnectionAdapter;
import com.cflint.adapter.DossierDetailStationInfoNameAdapter;
import com.cflint.adapter.DossierDetailStationInfoTextAdapter;
import com.cflint.adapter.DossierDetailTicketAdapter;
...
import com.cflint.model.StationIsVirtualText;
...
public class DossierDetailActivity extends BaseActivity {
    ...
    private void initBooking(){
        ...
        if(dossier.isHasInsurance() && generalSetting.getInsuranceConditionsPdf() != null && !generalSetting.getInsuranceConditionsPdf().isEmpty()){
...
//        Log.e("isExpandConnection", "isExpandConnection..." + isExpandConnection);
    ...
    public void click2call(View view){
        startActivity(com.cflint.activities.CallCenterActivity.createIntent(DossierDetailActivity.this, clickToCallScenarioId, null, dossier));
    }
    public void exchange(View view){
        startActivity(com.cflint.activities.CallCenterActivity.createIntent(DossierDetailActivity.this, ClickToCallService.Exchange, null, dossier));
    }
