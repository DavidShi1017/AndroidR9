...
import com.cflint.adapter.StationInfoAdapter;
import com.cflint.application.NMBSApplication;
import com.cflint.async.GetStationInfoAsync;
...
public class StationInfoActivity extends BaseActivity{
	...
	private void init(){
		if (!GetStationInfoAsync.isFinished){
			...
			LogUtils.e("stationInfoResponse", "stationInfoResponse ------->" + stationInfoResponse);
			setViewData();
		}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cflint.activities.MessageActivity.createIntent(StationInfoActivity.this, messageService.getMessageResponse()));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cflint.activities.StationBoardActivity.createIntent(StationInfoActivity.this, null));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cflint.activities.AlertActivity.createIntent(StationInfoActivity.this));
								isGoto = false;
								finish();
							}
						}
