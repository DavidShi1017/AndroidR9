...
import com.cflint.activities.view.DialogErrorLogin;
import com.cflint.activities.view.DialogInfo;
...
import com.cflint.async.ForgotPwdAsyncTask;
import com.cflint.async.LoginAsyncTask;

import com.cflint.async.ProfileInfoAsyncTask;
import com.cflint.async.ResendAsyncTask;
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.cflint.activities.MessageActivity.createIntent(getApplicationContext(),
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cflint.activities.StationBoardActivity.createIntent(getApplicationContext(), null));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cflint.activities.StationInfoActivity.createIntent(getApplicationContext()));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.cflint.activities.AlertActivity.createIntent(getApplicationContext()));
								isGoto = false;
								finish();
							}
						}
