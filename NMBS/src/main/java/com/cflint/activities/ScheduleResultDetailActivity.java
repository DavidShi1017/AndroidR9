...
import com.cflint.adapter.ScheduleDetailLegAdapter;
import com.cflint.adapter.ScheduleHafasMessageAdapter;
import com.cflint.application.NMBSApplication;
import com.cflint.async.CreateSubScriptionAsyncTask;
import com.cflint.async.ScheduleRefreshAsyncTask;
	...
	class ServiceCreateSubscriptionReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(!subscriptionId.equals("")){
				...
				if(!isFinishing()){
					dialogError = new DialogAlertError(ScheduleResultDetailActivity.this, getResources().getString(R.string.schedule_set_train_alert_failure_title),
