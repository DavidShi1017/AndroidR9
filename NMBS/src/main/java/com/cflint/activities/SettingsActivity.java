...
import com.cflint.R;
import com.cflint.activities.view.DialogChangeLanguageSuccessful;
import com.cflint.activities.view.DialogCheckUpdateNotification;
import com.cflint.activities.view.DialogMyOptions;
import com.cflint.activities.view.DialogSettingsNotifi;
import com.cflint.activities.view.DialogSettingsPassword;
import com.cflint.activities.view.ProgressDialogCustom;
import com.cflint.activity.BaseActivity;
import com.cflint.adapter.CollectionItemAdapter;
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            ...
                            if(isGoto){
                                startActivity(com.cflint.activities.MessageActivity.createIntent(SettingsActivity.this, messageService.getMessageResponse()));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cflint.activities.StationBoardActivity.createIntent(SettingsActivity.this, null));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cflint.activities.StationInfoActivity.createIntent(SettingsActivity.this));
                                isGoto = false;
                                finish();
                            }
                        }
            ...
            mDrawerLayout.setDrawerListener(
                    new DrawerLayout.SimpleDrawerListener() {
                        ...
                        public void onDrawerClosed(View drawerView) {
                            super.onDrawerClosed(drawerView);
                            if(isGoto){
                                startActivity(com.cflint.activities.AlertActivity.createIntent(SettingsActivity.this));
                                isGoto = false;
                                finish();
                            }
                        }
