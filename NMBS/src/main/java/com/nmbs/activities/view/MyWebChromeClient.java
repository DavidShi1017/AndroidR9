...
import com.nmbs.activities.WebViewPDFActivity;
        ...
        if(NetworkUtils.isOnline(activity)) {
            ...
            newWebView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                    ...
                    builder.setPositiveButton(activity.getString(R.string.alert_continue), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            handler.proceed();
                        }
                    });
                    builder.setNegativeButton(activity.getString(R.string.general_cancel), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            handler.cancel();
                        }
