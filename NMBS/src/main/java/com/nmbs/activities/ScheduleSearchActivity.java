...
public class ScheduleSearchActivity extends BaseActivity {
	...
	public void searchTrain(View view){
		...
		startActivityForResult(com.nmbs.activities.ScheduleResultActivity.createIntent(ScheduleSearchActivity.this,
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.nmbs.activities.MessageActivity.createIntent(ScheduleSearchActivity.this, messageService.getMessageResponse()));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.nmbs.activities.StationBoardActivity.createIntent(ScheduleSearchActivity.this, null));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.nmbs.activities.StationInfoActivity.createIntent(ScheduleSearchActivity.this));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.nmbs.activities.AlertActivity.createIntent(ScheduleSearchActivity.this));
								isGoto = false;
								finish();
							}
						}
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								if(NMBSApplication.getInstance().getLoginService().isLogon()){
									...
									GoogleAnalyticsUtil.getInstance().sendScreen(ScheduleSearchActivity.this, TrackerConstant.ProfileOverviewUrl);
								}else{
