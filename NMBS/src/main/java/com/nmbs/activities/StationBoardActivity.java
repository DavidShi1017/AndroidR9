			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								startActivity(com.nmbs.activities.MessageActivity.createIntent(StationBoardActivity.this,
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.nmbs.activities.StationInfoActivity.createIntent(StationBoardActivity.this));
								isGoto = false;
								finish();
							}
						}
			...
			mDrawerLayout.setDrawerListener(
					new DrawerLayout.SimpleDrawerListener() {
						...
						public void onDrawerClosed(View drawerView) {
							super.onDrawerClosed(drawerView);
							if(isGoto){
								startActivity(com.nmbs.activities.AlertActivity.createIntent(StationBoardActivity.this));
								isGoto = false;
								finish();
							}
						}
						...
						public void onDrawerClosed(View drawerView) {
							...
							if(isGoto){
								if(NMBSApplication.getInstance().getLoginService().isLogon()){
									...
									GoogleAnalyticsUtil.getInstance().sendScreen(StationBoardActivity.this, TrackerConstant.ProfileOverviewUrl);
								}else{
