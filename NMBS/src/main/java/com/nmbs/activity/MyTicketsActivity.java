...
import com.nmbs.activities.view.DialogSuccessful;
import com.nmbs.adapter.TicketsAdapter.ReloadCallback;
import com.nmbs.adapter.TicketsTitleAdapter;
import com.nmbs.adapter.TicketsTitleAdapter.RefreshCallback;
...
public class MyTicketsActivity extends BaseActivity implements RefreshOldDossierListener{
	...
	public void viewRefreshedDossier() {
		startActivity(com.nmbs.activities.MyTicketsActivity.createIntent(MyTicketsActivity.this));
		//loadData();
	}
