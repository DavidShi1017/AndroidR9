...
public class ForgotPwdInfoConverter {

    public ForgotPwdInfoResponse parseResponse(String jsonResponse) throws Exception{
        ForgotPwdInfoResponse response = null;
        try {
            ...
            response = gson.fromJson(jsonResponse, ForgotPwdInfoResponse.class);
